...
versioned outputs, raw predictions, and XAI audit files. Upon publication, the
audit, training, evaluation, and XAI code; environment specification; split
manifest; raw predictions; and derived non-identifying artifacts will be released
at a public GitHub repository. Model weights will be released only if compatible
with dataset and pretraining licenses.
